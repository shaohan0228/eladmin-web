<template>
  <div class="main-con">
    <div class="main-tit">知识库</div>
    <div class="main-content">
      <div class="table-top flex">
        <ita-button type="primary" class="mr-4" @click="toCreate">新增</ita-button>
...
import { getUploadKnowledgeList } from '../../../api/upload/knowledge'
export default {
  ...
  methods: {
    ...
    // 新增
    toCreate() {
      this.$router.push(`/upload_manage/knowledge/upload`)
    },
    // 上传
    toModify(rowData) {
